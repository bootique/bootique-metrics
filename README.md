...
[![build test deploy 1.x](https://github.com/bootique/bootique-metrics/actions/workflows/maven-1x.yml/badge.svg)](https://github.com/bootique/bootique-metrics/actions/workflows/maven-1x.yml)	
